...
def page():
    ...
    return html.div(
        ...
        Container(
            Column(
                Row(
                    list_roles(submitted_name, submitted_short_name),
...
def create_role_form(
    ...
    inp_name = Input(
        set_value=set_name, label="name of the role", width="[48%]", md_width="[48%]"
    )
...
def deactivate_role(set_deact_role):
    ...
    inp_deact_role = Input(
        set_value=set_role_to_deact,
        label="role id to be deactivated",
        width="96%",
        md_width="[96%]",
    )
    is_disabled = True
...
def activate_role(set_activ_role):
    ...
    inp_activ_role = Input(
        set_value=set_role_to_activ,
        label="role id to be activated",
        width="96%",
        md_width="[96%]",
    )
    is_disabled = True
